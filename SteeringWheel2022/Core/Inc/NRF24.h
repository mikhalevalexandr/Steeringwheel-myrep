...
#define RadioBTN HAL_GPIO_ReadPin(RadioBTN_GPIO_Port, RadioBTN_Pin)
...
#define LED_ON HAL_GPIO_WritePin(LEDG_GPIO_Port, LEDG_Pin, GPIO_PIN_RESET)

#define LED_OFF HAL_GPIO_WritePin(LEDG_GPIO_Port, LEDG_Pin, GPIO_PIN_SET)

#define LED_TGL HAL_GPIO_TogglePin(LEDG_GPIO_Port, LEDG_Pin)
